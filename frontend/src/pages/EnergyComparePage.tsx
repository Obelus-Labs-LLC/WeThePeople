      ...
      <div className="mx-auto max-w-[1400px] px-8 py-10 lg:px-16 lg:py-14">
        ...
        <div className="flex items-end gap-3 mb-8">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-2 rounded-lg bg-[#F97316] px-6 py-3 font-heading text-sm font-bold uppercase tracking-wider text-[#0a0a0f] transition-all hover:bg-[#F97316]/90 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            {comparing ? (
