      ...
      <div className="mx-auto max-w-[1400px] px-4 py-6 lg:px-16 lg:py-14">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3 mb-8">
          ...
          <button
            ...
            className="shrink-0 flex items-center justify-center gap-2 rounded-lg bg-[#34D399] px-6 py-3 font-heading text-sm font-bold uppercase tracking-wider text-[#0a0a0f] transition-all hover:bg-[#34D399]/90 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            {comparing ? (
