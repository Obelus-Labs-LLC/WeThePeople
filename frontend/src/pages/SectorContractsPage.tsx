...
const SECTOR_MAP: Record<string, SectorConfig> = {
  finance: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/finance/contracts?limit=500`,
  ...
  health: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/health/contracts?limit=500`,
    entityKey: 'companies',
  ...
  technology: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/tech/contracts?limit=500`,
    entityKey: 'companies',
  ...
  energy: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/energy/contracts?limit=500`,
    entityKey: 'companies',
  ...
  transportation: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/transportation/contracts?limit=500`,
    entityKey: 'companies',
  ...
  defense: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/defense/contracts?limit=500`,
    entityKey: 'companies',
  ...
  chemicals: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/chemicals/contracts?limit=500`,
    entityKey: 'companies',
  ...
  agriculture: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/agriculture/contracts?limit=500`,
    entityKey: 'companies',
  ...
  telecom: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/telecom/contracts?limit=500`,
    entityKey: 'companies',
  ...
  education: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/education/contracts?limit=500`,
    entityKey: 'companies',
