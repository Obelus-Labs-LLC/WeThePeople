...
const SECTOR_MAP: Record<string, SectorConfig> = {
  finance: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/finance/enforcement?limit=500`,
  ...
  health: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/health/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  technology: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/tech/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  energy: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/energy/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  transportation: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/transportation/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  defense: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/defense/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  chemicals: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/chemicals/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  agriculture: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/agriculture/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  telecom: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/telecom/enforcement?limit=500`,
    entityKey: 'companies',
  ...
  education: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/education/enforcement?limit=500`,
    entityKey: 'companies',
