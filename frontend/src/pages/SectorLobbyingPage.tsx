...
const SECTOR_MAP: Record<string, SectorConfig> = {
  ...
  transportation: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/transportation/lobbying?limit=1000`,
    entityKey: 'companies',
  ...
  defense: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/defense/lobbying?limit=1000`,
    entityKey: 'companies',
  ...
  chemicals: {
    ...
    aggregateEndpoint: `${API_BASE}/aggregate/chemicals/lobbying?limit=1000`,
    entityKey: 'companies',
