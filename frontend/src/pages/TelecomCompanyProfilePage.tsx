        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex items-center gap-3 flex-wrap">
              {detail.ticker && (
                <span className="rounded bg-cyan-500/20 px-3 py-1 font-mono text-sm font-bold text-cyan-400">
                  {detail.ticker}
                </span>
              )}
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                {detail.enforcement_count > 0 && (
                  <button onClick={() => setActiveTab('enforcement')} className="cursor-pointer rounded-xl border border-white/10 bg-white/[0.03] p-5 text-left transition-colors hover:bg-white/[0.06]">
                    ...
                    <p className="font-body text-xs text-white/40 mt-1">FCC enforcement data</p>
                  </button>
                )}
              </div>
