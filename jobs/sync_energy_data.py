...
import os
from connectors.sec_edgar import SEC_BROWSE_BASE, EFTS_BASE
...
def fetch_sec_filings(session, company: TrackedEnergyCompany, limit: int = 10000):
    ...
    url = f"{EFTS_BASE}/search-index?q=&dateRange=custom&startdt=2020-01-01&forms=10-K,10-Q,8-K&ciks={cik}"
