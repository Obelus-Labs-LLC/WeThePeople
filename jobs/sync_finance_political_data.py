    ...
    for year in years:
        ...
        while page_url:
            ...
            try:
                ...
                log.warning(f"  [{inst.institution_id}] Senate LDA error ({year}, page {page_num}): {e}")
                break
...
def fetch_contracts(session, inst: TrackedInstitution):
    ...
    while True:
        ...
        try:
            ...
            log.warning(f"  [{inst.institution_id}] USASpending error (page {page}): {e}")
            break
    ...
    try:
        ...
        for inst in institutions:
            ...
            try:
                ...
                log.error(f"FAILED {inst_id}: {e}", exc_info=True)
