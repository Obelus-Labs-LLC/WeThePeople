...
export const SECTORS: Sector[] = [
  ...
  },
  {
    slug: 'transportation',
    name: 'Transportation',
    tagline: 'Monitor vehicle safety and transit accountability',
    icon: '\u{1F697}',
    gradientStart: '#0EA5E9',
    gradientEnd: '#0369A1',
    route: 'TransportationDashboard',
    available: true,
  },
  {
    slug: 'defense',
  ...
  },
  {
    ...
    gradientEnd: '#15803D',
    route: 'AgricultureDashboard',
    available: true,
  },
  {
    slug: 'telecom',
    name: 'Telecommunications',
    tagline: 'Track carriers, spectrum fights, and net-neutrality lobbying',
    icon: '\u{1F4F6}',
  ...
  },
  {
    slug: 'education',
    name: 'Education',
    tagline: 'Audit universities, student-loan servicers, and testing giants',
    icon: '\u{1F393}',
