...
import { Search, HandCoins, ArrowLeft, Calendar, Building2 } from 'lucide-react';
...
export default function FederalGrantsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-10">
      ...
      {/* Header */}
      <div className="mb-8">
        <span className="text-xs font-bold tracking-[0.2em] text-green-400 uppercase">Grants</span>
        ...
        <p className="text-base text-zinc-400 mt-2 max-w-2xl">
          Search federal grant opportunities by keyword and agency. Find funding amounts, deadlines, categories, and eligibility requirements.
        </p>
      </div>
